...
-- Databases
CREATE OR REPLACE DATABASE DEMO_NB_DB;
GRANT OWNERSHIP ON DATABASE DEMO_NB_DB TO ROLE DEMO_ROLE;
...
CREATE EVENT TABLE DEMO_NB_DB.INTEGRATIONS.DEMO_EVENTS;
GRANT SELECT ON EVENT TABLE DEMO_NB_DB.INTEGRATIONS.DEMO_EVENTS TO ROLE DEMO_ROLE;
GRANT INSERT ON EVENT TABLE DEMO_NB_DB.INTEGRATIONS.DEMO_EVENTS TO ROLE DEMO_ROLE;

ALTER ACCOUNT SET EVENT_TABLE = DEMO_NB_DB.INTEGRATIONS.DEMO_EVENTS;
ALTER DATABASE DEMO_NB_DB SET LOG_LEVEL = INFO;
